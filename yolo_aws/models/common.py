...
"""
import sys 
sys.path.append('/home/ec2-user/environment//DincroML/MedicalNLU/tests/test_jaiber/yolo5_table_row/utils/')
import json
import math
import platform
import warnings
...
from utils.yolo5.dataloaders import exif_transpose, letterbox
from utils.yolo5.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, make_divisible, non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh,
                           yaml_load)
from utils.yolo5.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from utils.yolo5.export import export_formats
        ...
        for i, (im, pred) in enumerate(zip(self.ims, self.pred)):
            ...
            if pred.shape[0]:
                ...
                if show or save or render or crop:
                    annotator =5# Annotator(im, example=str(self.names))
